  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch">
      ...
      <el-form-item label="狀態" prop="status">
        <el-select v-model="queryParams.status" placeholder="選單狀態" clearable>
          <el-option
        ...
        <el-row>
          ...
          <el-col :span="12" v-if="form.menuType == 'C'">
            <el-form-item prop="routeName">
              ...
              <span slot="label">
                <el-tooltip content="預設不填則和路由地址相同：如地址為：`user`，則名稱為`User`（注意：為避免名字的衝突，特殊情況下請自定義，保證唯一性）" placement="top">
        ...
        <el-row>
          ...
          <el-col :span="12" v-if="form.menuType != 'M'">
            <el-form-item prop="perms">
              <el-input v-model="form.perms" placeholder="請輸入許可權標識" maxlength="100" />
              <span slot="label">
                <el-tooltip content="控制器中定義的許可權字元，如：@PreAuthorize(`@ss.hasPermi('system:user:list')`)" placement="top">
                <i class="el-icon-question"></i>
                </el-tooltip>
                許可權字元
              </span>
        ...
        <el-row>
          <el-col :span="12" v-if="form.menuType == 'C'">
            <el-form-item prop="query">
              <el-input v-model="form.query" placeholder="請輸入路由引數" maxlength="255" />
              <span slot="label">
                <el-tooltip content='訪問路由的預設傳遞引數，如：`{"id": 1, "name": "ry"}`' placement="top">
                <i class="el-icon-question"></i>
                </el-tooltip>
                路由引數
              </span>
          ...
          <el-col :span="12" v-if="form.menuType == 'C'">
            <el-form-item prop="isCache">
              <span slot="label">
                <el-tooltip content="選擇是則會被`keep-alive`快取，需要匹配元件的`name`和地址保持一致" placement="top">
                <i class="el-icon-question"></i>
                </el-tooltip>
                是否快取
              </span>
...
export default {
  ...
  methods: {
    ...
    /** 刪除按鈕操作 */
    handleDelete(row) {
      this.$modal.confirm('是否確認刪除名稱為"' + row.menuName + '"的資料項？').then(function() {
