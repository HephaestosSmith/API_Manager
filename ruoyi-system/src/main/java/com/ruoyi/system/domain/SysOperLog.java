...
public class SysOperLog extends BaseEntity
{
    ...
    /** 日誌主鍵 */
    @Schema(description = "操作序號")
    @Excel(name = "操作序號", cellType = ColumnType.NUMERIC)
    private Long operId;

    /** 操作模組 */
    @Schema(description = "操作模組")
    @Excel(name = "操作模組")
    private String title;

    /** 業務型別（0其它 1新增 2修改 3刪除） */
    @Schema(description = "業務型別")
    ...
    /** 請求方式 */
    @Schema(description = "請求方式")
    @Excel(name = "請求方式")
    private String requestMethod;

    /** 操作類別（0其它 1後臺使用者 2手機端使用者） */
    @Schema(description = "操作類別")
    ...
    /** 操作地點 */
    @Schema(description = "操作地點")
    @Excel(name = "操作地點")
    private String operLocation;

    /** 請求引數 */
    @Schema(description = "請求引數")
    @Excel(name = "請求引數")
    private String operParam;

    /** 返回引數 */
    @Schema(description = "返回引數")
    @Excel(name = "返回引數")
